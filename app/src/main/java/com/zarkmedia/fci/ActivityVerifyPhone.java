...
public class ActivityVerifyPhone extends AppCompatActivity {
    ...
    private PhoneAuthProvider.OnVerificationStateChangedCallbacks mCallbacks = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
        ...
        public void onVerificationFailed(FirebaseException e) {
            Toast.makeText(ActivityVerifyPhone.this, e.getMessage(), Toast.LENGTH_LONG).show();
        }
                ...
                .addOnCompleteListener(ActivityVerifyPhone.this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Intent intent = new Intent(ActivityVerifyPhone.this, ActivityVerifyPhone.class);
